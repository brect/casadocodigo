...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/casadocodigo$1.0.0/src/app/views/login/login.marko",
...
marko_template.meta = {
    id: "/casadocodigo$1.0.0/src/app/views/login/login.marko",
    tags: [
